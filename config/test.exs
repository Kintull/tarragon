...
config :tarragon, Tarragon.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "tarragon_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :tarragon, TarragonWeb.Endpoint,
  ...
  secret_key_base: "dAyxPaCA5Fl47J5LIRQzliHb4Tt8hscWpUK+Wj/DcspuycsulL8Yy8Pm3EmeQdHj",
  server: false

# In test we don't send emails.
config :tarragon, Tarragon.Mailer, adapter: Swoosh.Adapters.Test
