defmodule TarragonWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TarragonWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TarragonWeb.Gettext, "errors", msg, opts)
    end
  end
