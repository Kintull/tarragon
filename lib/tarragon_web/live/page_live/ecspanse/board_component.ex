defmodule TarragonWeb.PageLive.Ecspanse.BoardComponent do
  ...
  def render(assigns) do
    ...
    >
      <.live_component
        :for={hero <- @heroes}
        module={TarragonWeb.PageLive.Ecspanse.BoardHeroComponent}
...
defmodule TarragonWeb.PageLive.Ecspanse.BoardHeroComponent do
  use TarragonWeb, :live_component
